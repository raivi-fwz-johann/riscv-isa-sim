...
bool __attribute__((weak)) sv57_gigapage_hgatp(){
    TEST_START();
    ...
    L2_pagetable[3] = PTE_V | PTE_U | PTE_RWX | PTE_AD | page_addr_lower >> 2;
    L2_pagetable[4] = PTE_V | PTE_U | PTE_RWX | PTE_AD | page_addr_lower >> 2;
