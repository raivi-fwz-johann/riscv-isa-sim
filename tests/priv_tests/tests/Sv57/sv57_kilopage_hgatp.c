...
bool __attribute__((weak)) sv57_kilopage_hgatp(){
    TEST_START();
    ...
    L0_pagetable[0] = PTE_V | PTE_U | PTE_RWX | PTE_AD | page_addr_lower >> 2;
    L0_pagetable[1] = PTE_V | PTE_U | PTE_RWX | PTE_AD | page_addr_lower >> 2;
