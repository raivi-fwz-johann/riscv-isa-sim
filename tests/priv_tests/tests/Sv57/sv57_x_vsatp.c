...
extern reg_t sv57_vsatp_return_addr;
...
static void exception_shandler(){
    ...
    CSRW(sepc, (reg_t)(&sv57_vsatp_return_addr));
}
...
bool __attribute__((weak)) sv57_x_vsatp(){
    TEST_START();
...
static void exception_execute() {
    asm volatile (
        ...
        ".globl sv57_vsatp_return_addr\n\t"
        "sv57_vsatp_return_addr: \n\t"
        "nop \n\t"
    );
}
