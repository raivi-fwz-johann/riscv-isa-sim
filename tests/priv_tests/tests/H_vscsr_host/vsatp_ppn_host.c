...
static pte_t other_test_pagetable[TEST_PAGETABLE_SIZE] __attribute__((aligned(PAGE_SIZE)));
...
bool __attribute__((weak)) vsatp_ppn_host(){
    TEST_START();
    ...
    satp_ppn = csr_get_field(vsatp, VSATP_PPN_OFF, VSATP_PPN_LEN);
