...
bool __attribute__((weak)) vsstatus_mxr_host(){
    TEST_START();
    ...
    csr_set_field(vsstatus, VSSTATUS_MXR_OFF, VSSTATUS_MXR_LEN, 0);
    mxr = csr_get_field(vsstatus, VSSTATUS_MXR_OFF, VSSTATUS_MXR_LEN);
    TEST_COMPARE("check vsstatus.mxr is 0", 0, mxr);
    ...
    csr_set_field(vsstatus, VSSTATUS_MXR_OFF, VSSTATUS_MXR_LEN, 1);
    mxr = csr_get_field(vsstatus, VSSTATUS_MXR_OFF, VSSTATUS_MXR_LEN);
    TEST_COMPARE("check vsstatus.mxr is 1", 1, mxr);
