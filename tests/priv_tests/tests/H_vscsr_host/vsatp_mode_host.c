...
bool __attribute__((weak)) vsatp_mode_host(){
    TEST_START();
    ...
    set_shandler(satp_mode_shandler);                                                                                                                                                                             
    ...
    satp_mode = csr_get_field(vsatp, VSATP_MODE_OFF, VSATP_MODE_LEN);
    TEST_COMPARE("check vsatp.mode is BARE", SATP_BARE, satp_mode);
    ...
    satp_mode = csr_get_field(vsatp, VSATP_MODE_OFF, VSATP_MODE_LEN);
    TEST_COMPARE("check vsatp.mode is SV48", SATP_SV48, satp_mode);
