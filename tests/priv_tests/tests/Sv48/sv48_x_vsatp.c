...
extern reg_t sv48_vsatp_return_addr;
...
static void exception_shandler(){
    ...
    CSRW(sepc, (reg_t)(&sv48_vsatp_return_addr));
}
...
bool __attribute__((weak)) sv48_x_vsatp(){
    TEST_START();
...
static void exception_execute() {
    asm volatile (
        ...
        ".globl sv48_vsatp_return_addr\n\t"
        "sv48_vsatp_return_addr: \n\t"
        "nop \n\t"
    );
}
