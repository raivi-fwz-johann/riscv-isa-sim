...
bool __attribute__((weak)) vsstatus_sum_guest(){
    TEST_START();
    ...
    csr_set_field(sstatus, SSTATUS_SUM_OFF, SSTATUS_SUM_LEN, 0);
    sum = csr_get_field(sstatus, SSTATUS_SUM_OFF, SSTATUS_SUM_LEN);
    TEST_COMPARE("check sstatus.sum is 0", 0, sum);
    ...
    csr_set_field(sstatus, SSTATUS_SUM_OFF, SSTATUS_SUM_LEN, 1);
    sum = csr_get_field(sstatus, SSTATUS_SUM_OFF, SSTATUS_SUM_LEN);
    TEST_COMPARE("check sstatus.sum is 1", 1, sum);
