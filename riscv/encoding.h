...
/*code ext beg*/
#define MATCH_VKUZND_VS 0x0e00205b
#define MASK_VKUZND_VS  0xfe00707f
#define MATCH_VKUZND_VV 0x0a00205b
#define MASK_VKUZND_VV  0xfe00707f
#define MATCH_VKUZNE_VS 0x0600205b
#define MASK_VKUZNE_VS  0xfe00707f
#define MATCH_VKUZNE_VV 0x0200205b
#define MASK_VKUZNE_VV  0xfe00707f
#define MATCH_VKUZNZ_VS 0x1600205b
#define MASK_VKUZNZ_VS  0xfe00707f
#define MATCH_VKUZD_VS 0x5600202b
#define MASK_VKUZD_VS 0xfe00707f
#define MATCH_VKUZD_VV 0x5200202b
#define MASK_VKUZD_VV 0xfe00707f
#define MATCH_VKUZE_VS 0x4e00202b
#define MASK_VKUZE_VS 0xfe00707f
#define MATCH_VKUZE_VV 0x4a00202b
#define MASK_VKUZE_VV 0xfe00707f
#define MATCH_VMAGMA2R_VX 0x1a00605b
#define MASK_VMAGMA2R_VX  0xfe00707f
#define MATCH_VMAGMA2R_VS 0x2e00202b
#define MASK_VMAGMA2R_VS  0xfe00707f
#define MATCH_VMAGMA2R_VV 0x2a00202b
#define MASK_VMAGMA2R_VV  0xfe00707f
#define MATCH_VSBGLP_V 0x3200205b
#define MASK_VSBGLP_V  0xfe00707f
#define MATCH_VSBGLPH_VV 0x8600202b
#define MASK_VSBGLPH_VV 0xfe00707f
#define MATCH_VSBGLPL_VV 0x8a00202b
#define MASK_VSBGLPL_VV 0xfe00707f
#define MATCH_VSBGSX_VV 0x2200205b
#define MASK_VSBGSX_VV  0xfe00707f
#define MATCH_VSBGXS_VV 0x9200202b
#define MASK_VSBGXS_VV 0xfe00707f
/*code ext end*/
...
#define CAUSE_NO_EXCEPTION 0xff
...
/*code ext beg*/
DECLARE_INSN(vkuznd_vs, MATCH_VKUZND_VS, MASK_VKUZND_VS)
DECLARE_INSN(vkuznd_vv, MATCH_VKUZND_VV, MASK_VKUZND_VV)
DECLARE_INSN(vkuzne_vs, MATCH_VKUZNE_VS, MASK_VKUZNE_VS)
DECLARE_INSN(vkuzne_vv, MATCH_VKUZNE_VV, MASK_VKUZNE_VV)
DECLARE_INSN(vkuznz_vs, MATCH_VKUZNZ_VS, MASK_VKUZNZ_VS)
DECLARE_INSN(vkuzd_vs, MATCH_VKUZD_VS, MASK_VKUZD_VS)
DECLARE_INSN(vkuzd_vv, MATCH_VKUZD_VV, MASK_VKUZD_VV)
DECLARE_INSN(vkuze_vs, MATCH_VKUZE_VS, MASK_VKUZE_VS)
DECLARE_INSN(vkuze_vv, MATCH_VKUZE_VV, MASK_VKUZE_VV)
DECLARE_INSN(vmagma2r_vx, MATCH_VMAGMA2R_VX, MASK_VMAGMA2R_VX)
/*code ext end*/
...
/*code ext beg*/
DECLARE_INSN(vmagma2r_vs, MATCH_VMAGMA2R_VS, MASK_VMAGMA2R_VS)
DECLARE_INSN(vmagma2r_vv, MATCH_VMAGMA2R_VV, MASK_VMAGMA2R_VV)
/*code ext end*/
...
DECLARE_INSN(vsbglp_v, MATCH_VSBGLP_V, MASK_VSBGLP_V)
DECLARE_INSN(vsbgsx_vv, MATCH_VSBGSX_VV, MASK_VSBGSX_VV)
...
/*code ext beg*/
DECLARE_INSN(vsbglph_vv, MATCH_VSBGLPH_VV, MASK_VSBGLPH_VV)
DECLARE_INSN(vsbglpl_vv, MATCH_VSBGLPL_VV, MASK_VSBGLPL_VV)
DECLARE_INSN(vsbgxs_vv, MATCH_VSBGXS_VV, MASK_VSBGXS_VV)
/*code ext end*/
